...
// Fetch Schedules (only own for all users)
$email = $_SESSION['email'] ?? '';
$stmt = $conn->prepare("SELECT * FROM employee_schedules WHERE employee_email = ? ORDER BY date");
...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="nav flex-column">
      <li class="nav-item">
        <a class="nav-link active" href="PEP_EmployeeSchedule.php"><i class="bi bi-calendar-event me-2"></i>View Schedule</a>
      </li>
      <li class="nav-item">
